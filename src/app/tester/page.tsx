...
//     const [editingBugId, setEditingBugId] = useState<string | null>(null); // Track if editing
...
//       if (editingBugId) {
//         // Update bug
//         await update.mutateAsync({ id: editingBugId, updates: formData });
//         setMessage('Bug updated successfully!');
//         setEditingBugId(null);
//       } else {
//         // Create new bug
