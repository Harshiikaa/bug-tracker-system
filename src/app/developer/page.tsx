...
// export default function DeveloperDashboard() {
//   const { user } = useAuth();
//   const { token, getBugsQuery, getAllBugsQuery } = useBugs();
//   const router = useRouter();
//   const params = useParams();
...
//   // If bugId is provided, extract it from bugs array
//   useEffect(() => {
//     if (bugId && bugs.length > 0) {
//       const found = bugs.find((b) => b._id === bugId);
//       if (found) {
...
//   const getAssignedToName = (assignedTo: Bug['assignedTo']) => {
...
//             </td>
//             <td className="p-4 text-gray-600">{b.createdBy?.name || 'Unknown'}</td>
//             {/* <td className="p-4 text-gray-600">{getAssignedToName(b.assignedTo)}</td> */}
//           </tr>
//         ))}
//       </tbody>
//     </table>
